...
<h2 class="main_content_title"> Nuevo Juego de ${SportID.str(data.sportId)} </h2>
<form id="newMatchForm" role="form" class="form-horizontal" action="<%=MatchEventController.URL%>" method="POST">
    ...
    <div class="form-group">
        ...
        <div class="col-md-4">
            <input type="text" class="form-control input-sm" name="${Param.NAME}" value="${data.name}" placeholder="Nombre">
        </div>
    ...
    <div class="form-group">
        ...
        <div class="col-md-4">
            <input id="nt${i}" type="text" class="team_name form-control input-sm" name="${Param.NAME} ${i}" value="${data.getTeam(i)}" placeholder="Nombre">
        </div>
    ...
    <div class="col-md-6" style="text-align: center">
        <button class="btn btn-submit" id="btnNewMatch"><span class="glyphicon glyphicon-check"></span> Crear</button>
    </div>
</form>