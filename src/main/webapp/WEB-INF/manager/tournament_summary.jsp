<%-- 
    Document   : tournament_summary
    Created on : Mar 16, 2016, 9:49:43 PM
    Author     : eduarc
--%>
...
<html>
    <head>
        ...
        <title>BookMaker - Resumen de Torneo</title>
    </head>
    <body>
        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <jsp:include page="<%=TournamentController.getJSP(TournamentController.SUMMARY)%>">
