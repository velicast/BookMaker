...
<nav class="navbar navbar-default" role="navigation">
    ...
    <ul class="main_menu nav navbar-nav">
        <!-- Dropdown-->
        <li id="agencySummary"><a href="<%=ManagerController.URL%>?to=<%=ManagerController.AGENCY_SUMMARY%>"><span class="glyphicon glyphicon-user"></span> Agency</a></li>
        ...
        <li id="searchMatch"><a href="<%=ManagerController.URL%>?to=<%=ManagerController.SEARCH_MATCH%>"><span class="glyphicon glyphicon-search"></span> Match</a></li>
    </ul>
</nav>
