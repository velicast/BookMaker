<%-- 
    Document   : employee_summary
    Created on : Mar 13, 2016, 7:51:42 PM
    Author     : eduarc
--%>
...
<html>
    <head>
        ...
        <title>BookMaker - Employee Summary</title>
    </head>
    <body>
        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div id="mainContent" class="col-md-9 side-body">
                    <jsp:include page="<%=FinalUserController.getJSP(FinalUserController.SUMMARY)%>"></jsp:include>
                </div>
            </div>
        </div>
