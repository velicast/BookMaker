...
<form id="searchTournamentForm" role="form" class="form-horizontal" action="<%=TournamentController.URL%>" method="GET">
    ...
    <div class="form-group">
        ...
        <div class="col-md-7">
            <input type="checkbox" class="" name="${Param.ACTIVE_MATCHES}" ${requestScope[Attr.ACTIVE_MATCHES] != null ? "checked" : ""}> With active matches (Accepting bets)
        </div>
    ...
    <div class="col-md-6" style="text-align: center">
        <button class="btn btn-submit" id="btnSearchTournament"><span class="glyphicon glyphicon-search"></span> Search</button>
    </div>
</form>