...
<h2 class="main_content_title"> New User </h2>
...
<form id="newUserForm" role="form" class="form-horizontal" action="<%=FinalUserController.URL%>" method="POST">
    ...
    <div class="form-group">
        ...
        <div class="col-md-4">
            ...
            <span class = "help-block">Min 4 characters long</span>
        </div>
    ...
    <div class="col-md-6" style="text-align: center">
        <button type="submit" id="btnCreateNewUser" class="btn btn-submit"><span class="glyphicon glyphicon-check"></span> Create</button>
    </div>
</form>