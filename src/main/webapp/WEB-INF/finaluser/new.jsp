<%-- 
    Document   : new_user
    Created on : Feb 14, 2016, 8:31:26 PM
    Author     : eduarc
--%>
...
<h2 class="main_content_title"> Nuevo Usuario </h2>

<form id="newUserForm" role="form" class="form-horizontal" action="<%=FinalUserController.URL%>" method="POST">
    <input type="hidden" name="do" value="<%=FinalUserController.NEW%>">
    <div class="form-group">
        <output class="col-md-7" style="text-align: center">Campos marcados con * son obligatorios</output>
    </div>
    <div class="form-group">
        <label class="col-md-2 control-label">* Ususario:</label>
        <div class="col-md-4">
    ...
    <div class="form-group">
        ...
        <div class="col-md-4">
            ...
            <span class = "help-block">Min. 4 caracteres de largo</span>
        </div>
    ...
    <div class="col-md-6" style="text-align: center">
        <button type="submit" id="btnCreateNewUser" class="btn btn-submit"><span class="glyphicon glyphicon-check"></span> Crear</button>
    </div>
</form>