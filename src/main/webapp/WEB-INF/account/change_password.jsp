<%-- 
    ...
    Created on : Mar 15, 2016, 6:07:01 PM
    Author     : eduarc
--%>
...
<html>
    <head>
        ...
        <title>BookMaker - Change Password</title>
        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div id="mainContent" class="col-md-9 side-body">
                    <jsp:include page="<%=FinalUserController.getJSP(FinalUserController.CHANGE_PASSWORD)%>"></jsp:include>
                </div>
            </div>
        </div>
