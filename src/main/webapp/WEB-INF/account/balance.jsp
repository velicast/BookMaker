<%-- 
    Document   : balance
    Created on : Mar 15, 2016, 6:47:13 PM
    Author     : eduarc
--%>
...
<html>
    <head>
        ...
        <title>BookMaker - Account Summary</title>
        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div id="mainContent" class="col-md-9 side-body">
                    <jsp:include page="<%=FinalUserController.getJSP(FinalUserController.BALANCE)%>"></jsp:include>
                </div>
            </div>
        </div>
