<%-- 
    Document   : edit_agency
    Created on : Feb 17, 2016, 5:42:36 PM
    Author     : eduarc
--%>
...
<html>
    <head>
        ...
        <title>BookMaker - New Agency</title>
    </head>
    <body>
        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div id="mainContent" class="col-md-9 side-body">
                    <jsp:include page="<%=AgencyController.getJSP(AgencyController.EDIT)%>"></jsp:include>
                </div>
            </div>
        </div>
