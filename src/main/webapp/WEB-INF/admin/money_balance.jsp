<%-- 
    Document   : money_balance
    Created on : Mar 17, 2016, 11:23:37 AM
    Author     : eduarc
--%>
...
<html>
    <head>
        ...
        <title>BookMaker - Balance de Dinero</title>
    </head>
    <body>
        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div id="mainContent" class="col-md-9 side-body">
                    <jsp:include page="<%=AdminController.getJSP("balance/"+AdminController.MONEY)%>">
