<%-- 
    Document   : agency_summary
    Created on : Feb 17, 2016, 5:42:15 PM
    Author     : eduarc
--%>
...
<html>
    <head>
        ...
        <title>BookMaker - Resumen de Agencia</title>
    </head>
    <body>
        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div id="mainContent" class="col-md-9 side-body">
                    <jsp:include page="<%=AgencyController.getJSP(AgencyController.SUMMARY)%>">
