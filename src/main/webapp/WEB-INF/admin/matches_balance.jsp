...
<html>
    <head>
        ...
        <title>BookMaker - Balance de Juegos</title>
    </head>
    <body>
        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div id="mainContent" class="col-md-9 side-body">
                    <jsp:include page="<%=AdminController.getJSP("balance/"+AdminController.MATCHES)%>">
        ...
        <script>
            $(document).ready(function() {
                $('#matchesBalance').addClass("active");
