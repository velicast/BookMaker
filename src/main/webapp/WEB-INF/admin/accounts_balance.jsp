<%-- 
    Document   : accounts_balance
    Created on : Mar 17, 2016, 11:22:26 AM
    Author     : eduarc
--%>
...
<html>
    <head>
        ...
        <title>BookMaker - Balance de Cuentas</title>
    </head>
    <body>
        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div id="mainContent" class="col-md-9 side-body">
                    <jsp:include page="<%=AdminController.getJSP("balance/"+AdminController.ACCOUNTS)%>">
        ...
        <script>
            $(document).ready(function() {
                $('#accountsBalance').addClass("active");
                $('#menuBalance').collapse("show");
