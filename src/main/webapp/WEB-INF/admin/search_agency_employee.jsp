<%-- 
    Document   : search_agency_employee
    Created on : Feb 22, 2016, 10:50:12 PM
    Author     : eduarc
--%>
...
<html>
    <head>
        ...
        <title>BookMaker - Search User</title>
    </head>
    <body>
        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div id="mainContent" class="col-md-9 side-body">
                    <jsp:include page="<%=FinalUserController.getJSP(FinalUserController.SEARCH_EMPLOYEE)%>"></jsp:include>
                </div>
            </div>
        </div>
