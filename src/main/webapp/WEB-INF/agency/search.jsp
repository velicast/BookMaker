...
<h2 class="main_content_title"> Buscar Agencia </h2>
    ...
    <div class="form-group">
        ...
        <div class="col-md-4">
            <div class="input-group">
                <input type="text" class="form-control input-sm" id="managerToSearch" name="${Param.USERNAME}" value="${requestScope[Attr.USERNAME]}" placeholder="Usuario">
