<%-- 
    Document   : match_result
    Created on : Feb 29, 2016, 1:26:24 AM
    Author     : eduarc
--%>
...
<html>
    <head>
        ...
        <title>BookMaker - Match Result</title>
    </head>
    <body>
        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <jsp:include page="<%=MatchEventController.getJSP(MatchEventController.RESULT) %>"></jsp:include>
                </div>
            </div>
        </div>
