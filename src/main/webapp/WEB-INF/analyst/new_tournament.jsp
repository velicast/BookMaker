<%-- 
    Document   : new_tournament
    Created on : Feb 23, 2016, 2:58:37 PM
    Author     : eduarc
--%>
...
<html>
    <head>
        ...
        <title>BookMaker - Nuevo Torneo</title>
    </head>
    <body>
        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <jsp:include page="<%=TournamentController.getJSP(TournamentController.NEW) %>">
