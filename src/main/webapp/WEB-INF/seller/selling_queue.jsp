<%-- 
    Document   : selling_queue
    Created on : Feb 19, 2016, 11:57:09 AM
    Author     : eduarc
--%>
...
<html>
    <head>
        ...
        <link rel="stylesheet" href="/BookMaker/css/seller/seller.css">
        
        <title>BookMaker - Selling Queue</title>
        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div id="mainContent" class="col-md-9 side-body">
                    <h2 class="main_content_title"> My Selling Queue </h2>
                    <jsp:include page="<%=ParlayController.getJSP(ParlayController.TABLE_SUMMARY)%>"></jsp:include>
                </div>
            </div>
        </div>
